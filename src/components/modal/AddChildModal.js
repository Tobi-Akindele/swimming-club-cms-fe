...
const AddChildModal = ({ showModal, setShowModal, parentId }) => {
  ...
  const validate = Yup.object({
    childId: Yup.string().required('Username is required'),
  });
      ...
      {showModal ? (
        <Background onClick={closeModal} ref={modalRef}>
          <ModalWrapper showModal={showModal}>
            <ModalContentTop>
              <ModalContentTopTitle>Add Child</ModalContentTopTitle>
            </ModalContentTop>
                ...
                onSubmit={(values, { resetForm }) => {
                  ...
                  openRequest
                    ...
                    .then((result) => {
                      setIsAdding(false);
                      resetForm({});
                      toast.success('Child added successful');
                      setTimeout(() => {
                ...
                {(formik) => (
                  <Form>
                    <DataListInput
                      ...
                      error={formik.errors.childId}
                      touched={formik.touched.childId}
                      width='350px'
                    />
                    <ButtonContainer>
                      <ButtonUpdate
